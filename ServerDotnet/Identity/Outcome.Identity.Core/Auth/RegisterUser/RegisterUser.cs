...
public sealed record RegisterUserCommand(string Email, string Username, string Password, string InviteCode, string? Device, string Ip, long? HostServerId = null)
    : ICommand<AuthResult>;

/**
 * Lucide SVG icon component (ported verbatim from the deprecated client's lib/icons.ts).
 * Paths are static Lucide data; rendered as inline SVG with `currentColor` stroke so icons
 * inherit the parent's text color. Replaces emoji throughout the UI.
 */

export type IconName =
  | "mic" | "mic-off" | "headphones" | "headphones-off" | "camera" | "camera-off"
  | "monitor" | "monitor-off" | "phone" | "phone-off" | "phone-down" | "volume-2" | "volume-x"
  | "pin" | "pin-off" | "users" | "settings" | "smile" | "send" | "reply" | "pencil"
  | "trash-2" | "file-text" | "download" | "chevron-down" | "chevron-right" | "x"
  | "eye" | "eye-off" | "flag" | "shield-off" | "play" | "pause" | "check" | "external-link" | "loader"
...
const ICON_PATHS: Record<IconName, string> = {
  ...
  // The classic "hang up" glyph: the phone handset rotated face-down. Used on every
  // decline / cancel / leave-call button (the slashed phone reads as "call failed").
  "phone-down": `<g transform="rotate(135 12 12)"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></g>`,
  ...
  // Four corners pushing out / pulling in — the standard fullscreen pair.
  ...
  "shield-off": `<path d="M19.7 14a6.9 6.9 0 0 0 .3-2V5l-8-3-3.2 1.2"/><path d="m4.3 4.3 1.7-.6V12c0 6 6 10 6 10a20.3 20.3 0 0 0 5.1-4.4"/><line x1="2" x2="22" y1="2" y2="22"/>`,
...
/** Inline Lucide SVG icon. Inherits color via `currentColor`. */

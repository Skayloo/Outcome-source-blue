 ...
 * third-party sign-in at all, could not get into such an account. This gate asks for a
 * password straight after a provider sign-in and does not hand over the app until it is set.
 */
type Mode = "none" | "set";
